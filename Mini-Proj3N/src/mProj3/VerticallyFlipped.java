...
public class VerticallyFlipped implements TextBlock {
 ...
 public boolean eqv(TextBlock cmp) {
	  ...
	  return (((cmp instanceof VerticallyFlipped) && this.top.eqv((((VerticallyFlipped) cmp).top))) // checks the top path then bottom then calls both recursively
			  && this.bottom.eqv((((VerticallyFlipped) cmp).bottom)));
 }
